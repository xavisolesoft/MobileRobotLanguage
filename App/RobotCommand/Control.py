class CommandController:
    ...
    def execute_command(self, command_definition, arguments):
        ...
        return command_definition.get_command_output_generator()(response)

    def __create_command_request(self, command_definition, arguments):
        request = command_definition.get_request_class()()
        request.set_id(self.__get_next_command_id())
        command_definition.get_custom_interpreter_arguments_request_setter()(arguments, request)
        return request

    def __execute_command_request(self, command_definition, request):
        executor = command_definition.get_executor_class()(self.world_model)
